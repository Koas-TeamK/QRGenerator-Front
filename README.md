...
- **미리보기**: 최대 50개의 QR 코드를 미리 확인하거나 전체 목록 조회가 가능합니다
...
4. **Base64 변환**: QR 이미지를 Base64로 인코딩하여 용량을 축소합니다(width=128, margin=1)
...
### VITE_QR_BASE_URL
QR 코드의 기본 베이스 URL을 설정합니다. 미설정 시 기본값: `www.team-koas.com`
